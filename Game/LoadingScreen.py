...
class LoadingScreen:
    ...
    def __init__(self):
        ...
        self.__count = 0
        self.gui = loader.loadModel('resources/phase_3/models/gui/progress-background.bam')
        self.title = DirectLabel(guiId='ToontownLoadingScreenTitle', parent=self.gui, relief=None, pos=(base.a2dRight/5, 0, 0.235), text='', textMayChange=1, text_scale=0.08, text_fg=(0, 0, 0.5, 1), text_shadow=(0, 0, 0, 1), text_align=TextNode.ALeft, text_font=ToontownGlobals.getInterfaceFont())
        self.tip = DirectLabel(guiId='ToontownLoadingScreenTip', parent=self.gui, relief=None, pos=(0, 0, 1), text='', textMayChange=1, text_scale=0.05, text_fg=(1, 1, 1, 1), text_shadow=(0, 0, 0, 1),text_wordwrap=13, text_align=TextNode.ACenter)
        ...
        self.logo = OnscreenImage(
            image='resources/phase_3/maps/toontown-logo.png',
            scale=(1, 1, .5))
